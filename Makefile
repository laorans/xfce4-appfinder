...
pkgdatadir = $(datadir)/xfce4-appfinder
pkgincludedir = $(includedir)/xfce4-appfinder
pkglibdir = $(libdir)/xfce4-appfinder
pkglibexecdir = $(libexecdir)/xfce4-appfinder
...
ACLOCAL = ${SHELL} /media/storage/opt/xfce4/xfce4-appfinder/missing aclocal-1.15
...
AR = ar
AUTOCONF = ${SHELL} /media/storage/opt/xfce4/xfce4-appfinder/missing autoconf
AUTOHEADER = ${SHELL} /media/storage/opt/xfce4/xfce4-appfinder/missing autoheader
AUTOMAKE = ${SHELL} /media/storage/opt/xfce4/xfce4-appfinder/missing automake-1.15
AWK = gawk
...
EXEEXT = 
FGREP = /bin/grep -F
GARCON_CFLAGS = -pthread -I/usr/include/garcon-1 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include
GARCON_LIBS = -lgarcon-1 -lgio-2.0 -lgthread-2.0 -pthread -lgobject-2.0 -lglib-2.0
GARCON_REQUIRED_VERSION = 0.3.0
GARCON_VERSION = 0.4.0
...
LDFLAGS = -Wl,-Bsymbolic-functions -fPIE -pie -Wl,-z,relro -Wl,-z,now -Wl,--as-needed -Wl,-O1 -Wl,-z,defs -Wl,--as-needed -Wl,-O1
LIBOBJS = 
LIBS = 
...
LIBXFCE4UI_LIBS = -lxfce4ui-1 -lgtk-x11-2.0 -lgdk-x11-2.0 -lpangocairo-1.0 -latk-1.0 -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lfontconfig -lfreetype -lxfce4util -lglib-2.0
LIBXFCE4UI_REQUIRED_VERSION = 4.10.0
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /media/storage/opt/xfce4/xfce4-appfinder/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
...
PACKAGE_STRING = xfce4-appfinder 4.12.1
...
USE_NLS = yes
VERSION = 4.12.1
XFCONF_CFLAGS = -I/usr/include/xfce4/xfconf-0 -I/usr/include/dbus-1.0 -I/usr/lib/x86_64-linux-gnu/dbus-1.0/include -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include
...
abs_builddir = /media/storage/opt/xfce4/xfce4-appfinder
abs_srcdir = /media/storage/opt/xfce4/xfce4-appfinder
abs_top_builddir = /media/storage/opt/xfce4/xfce4-appfinder
abs_top_srcdir = /media/storage/opt/xfce4/xfce4-appfinder
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /media/storage/opt/xfce4/xfce4-appfinder/install-sh
